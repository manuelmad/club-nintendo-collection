function searchByPoster(inventory, img_ext) {
    ...
    inventory.forEach(magazine => {
        ...
        const search_word = (search_poster_input.value).toUpperCase();

        // Logic to check if the search input is included in the keywords of the magazine's poster
